...
// To add a new event type, add its color here — no other changes needed
const TYPE_COLORS = {
  Hackathon:   '#5570f1',
  Workshop:    '#22c97a',
  'Build Night':'#5570f1',
...
const isUpcoming = e => new Date(e.year, MONTH_INDEX[e.month], Number(e.day)) >= new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate());
